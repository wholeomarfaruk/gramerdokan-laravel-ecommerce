        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box mt-5 mb-27">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" target="_blank" href="{{ route('order.received_custom',$order->id) }}">Fire Purchase Event</a>
                                ...
                                @foreach ($orderItems as $item)
                                    <tr>
                                        <td class="pname">
                                            ...
                                            <div class="name">
                                                <a href="{{ route('product.show', ['slug' => $item->product->slug,'segment' => $item->product->segment]) }}" target="_blank"
                        ...
                        <div class="w-half">
                            ...
                            <div class="my-account__address-item col-md-6">
                                ...
                                <div class="my-account__address-item__detail">
                                    <p>Name : {{ $order->name }}</p>
                                    <p>Mobile : {{ $order->phone }}


                                        @if ($customer)
                                            <a class="btn btn-primary" target="_blank" href="{{ route('admin.customers.details', $customer->id) }}">Profile</a>
                                        @else
                                            <a class="btn btn-primary" target="_blank" href="{{ route('admin.orders.customer.create',$order->id) }}">Create Profile</a>
                                        @endif
                                    </p>
            ...
            <div class="wg-box mt-5">
                ...
                <div class="my-account__address-item col-md-12">
                    <div class="my-account__address-item__detail">
                        ...
                        <p>Tracking Event:</p>
                        <pre style="font-size: 14px; line-height: 20px; "> {{ json_encode($order->trackingEvent, JSON_PRETTY_PRINT) }}</pre>
                        <p>Order Data:</p>
